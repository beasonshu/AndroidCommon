...
public final class Headers {
    ...
    Headers(Builder builder) {
        mNamesAndValues = builder.namesAndValues.toArray(new String[builder.namesAndValues.size()]);
    }

    private Headers(String[] namesAndValues) {
        mNamesAndValues = namesAndValues;
    }
    ...
    String get(String name) {
        return get(mNamesAndValues, name);
    }
    ...
    public Builder newBuilder() {
        ...
        Collections.addAll(result.namesAndValues, mNamesAndValues);
        return result;
    }

    public static Builder newBuilder(String[] namesAndValues) {
        Builder result = new Builder();
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof Headers
                && Arrays.equals(((Headers) other).mNamesAndValues, mNamesAndValues);
    }

    @Override
    public int hashCode() {
        return Arrays.hashCode(mNamesAndValues);
    }
    ...
    public static Headers of(String... namesAndValues) {
        if (namesAndValues == null) throw new NullPointerException("mNamesAndValues == null");
    ...
    public static final class Builder {
        ...
        public Builder add(String name, String value) {
            if (TextUtils.isEmpty(name) || value == null) {
                Log.i(TAG, "set: name is empty or value is null");
                return this;
            }
        ...
        public Builder add(Map<String, String> headers) {
            if (headers != null) {
                for (Map.Entry<String, String> header : headers.entrySet()) {
                    if (header.getKey() == null || header.getValue() == null) {
                        throw new IllegalArgumentException("Headers cannot be null");
