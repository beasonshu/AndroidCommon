...
package tk.beason.common.widget.tablayout;
 ...
 */
public class TabLayoutPro extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link TabLayoutPro} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TabLayoutPro}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public TabLayoutPro(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.TabLayoutPro_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabPaddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(R.styleable.TabLayoutPro_tabTextAppearance,
        ...
        if (a.hasValue(R.styleable.TabLayoutPro_tabSelectedTextColor)) {
            ...
            final int selected = a.getColor(R.styleable.TabLayoutPro_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.TabLayoutPro_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.TabLayoutPro_tabContentStart, 0);
        mMode = a.getInt(R.styleable.TabLayoutPro_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.TabLayoutPro_tabGravity, GRAVITY_FILL);
        a.recycle();
    ...
    private void addTabFromItemView(@NonNull TabItemPro item) {
    ...
    /**
     * Add a {@link TabLayoutPro.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link TabLayoutPro.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link TabLayoutPro.OnTabSelectedListener}s.
     */
     ...
     * @attr ref android.support.design.R.styleable#TabLayoutPro_tabMode
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Returns the current mode used by this {@link TabLayoutPro}.
     *
     * @see #setTabMode(int)
     */
    @SuppressWarnings("unused")
     ...
     * @attr ref android.support.design.R.styleable#TabLayoutPro_tabGravity
     */
    @SuppressWarnings("unused")
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref android.support.design.R.styleable#TabLayoutPro_tabTextColor
     * @attr ref android.support.design.R.styleable#TabLayoutPro_tabSelectedTextColor
     */
    ...
    /**
     * The one-stop shop for setting up this {@link TabLayoutPro} with a {@link ViewPager}.
     *
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TabItemPro) {
            addTabFromItemView((TabItemPro) child);
        } else {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private boolean isTabIndicatorRound;
        ...
        void setIndicatorRound(boolean round) {
            if (isTabIndicatorRound != round) {
                isTabIndicatorRound = round;
            }
        }
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (isTabIndicatorRound) {
                    canvas.drawRoundRect(left,
                            ...
                            right,
                            bottom,
                            9999, 9999, mSelectedIndicatorPaint);
                } else {
                    canvas.drawRect(left, top,
                            right, bottom, mSelectedIndicatorPaint);
                }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayoutPro> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        TabLayoutOnPageChangeListener(TabLayoutPro tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TabLayoutPro tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    public static class ViewPagerOnTabSelectedListener implements TabLayoutPro.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(TabLayoutPro.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(TabLayoutPro.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(TabLayoutPro.Tab tab) {
            // No-op
        }
    }
