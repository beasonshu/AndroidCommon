...
import tk.beason.common.utils.ColorUtils;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        thumbDrawable = a.getDrawable(R.styleable.SwitchButton_thumbDrawable);
        thumbColor = a.getColorStateList(R.styleable.SwitchButton_thumbColor);
        margin = a.getDimension(R.styleable.SwitchButton_thumbMargin, margin);
        marginLeft = a.getDimension(R.styleable.SwitchButton_thumbMarginLeft, margin);
        marginRight = a.getDimension(R.styleable.SwitchButton_thumbMarginRight, margin);
        marginTop = a.getDimension(R.styleable.SwitchButton_thumbMarginTop, margin);
        marginBottom = a.getDimension(R.styleable.SwitchButton_thumbMarginBottom, margin);
        thumbWidth = a.getDimension(R.styleable.SwitchButton_thumbWidth, thumbWidth);
        thumbHeight = a.getDimension(R.styleable.SwitchButton_thumbHeight, thumbHeight);
        thumbRadius = a.getDimension(R.styleable.SwitchButton_thumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
        backRadius = a.getDimension(R.styleable.SwitchButton_backgroundRadius, thumbRadius + density * 2f);
        backDrawable = a.getDrawable(R.styleable.SwitchButton_backgroundDrawable);
        backColor = a.getColorStateList(R.styleable.SwitchButton_backgroundColor);
        backMeasureRatio = a.getFloat(R.styleable.SwitchButton_backgroundMeasureRatio, backMeasureRatio);
        animationDuration = a.getInteger(R.styleable.SwitchButton_animationDuration, animationDuration);
        fadeBack = a.getBoolean(R.styleable.SwitchButton_fadeBack, true);
        tintColor = a.getColor(R.styleable.SwitchButton_tintColor, tintColor);
        a.recycle();
